...
void QuestionUIAbstract::cb_answerRB(fltk::RadioButton* o, long v) {
  ((QuestionUIAbstract*)(o->parent()->parent()->parent()->parent()->parent()->user_data()))->cb_answerRB_i(o,v);
}
...
void QuestionUIAbstract::cb_answerRB1(fltk::RadioButton* o, long v) {
  ((QuestionUIAbstract*)(o->parent()->parent()->parent()->parent()->parent()->user_data()))->cb_answerRB1_i(o,v);
}
...
void QuestionUIAbstract::cb_answerRB2(fltk::RadioButton* o, long v) {
  ((QuestionUIAbstract*)(o->parent()->parent()->parent()->parent()->parent()->user_data()))->cb_answerRB2_i(o,v);
}
...
void QuestionUIAbstract::cb_answerRB3(fltk::RadioButton* o, long v) {
  ((QuestionUIAbstract*)(o->parent()->parent()->parent()->parent()->parent()->user_data()))->cb_answerRB3_i(o,v);
}
...
void QuestionUIAbstract::cb_exitBtn(fltk::Button* o, void* v) {
  ((QuestionUIAbstract*)(o->parent()->parent()->parent()->parent()->user_data()))->cb_exitBtn_i(o,v);
}
...
void QuestionUIAbstract::cb_fullscreenBtn(fltk::Button* o, void* v) {
  ((QuestionUIAbstract*)(o->parent()->parent()->parent()->parent()->user_data()))->cb_fullscreenBtn_i(o,v);
}
...
void QuestionUIAbstract::cb_validateBtn(fltk::Button* o, const char* v) {
  ((QuestionUIAbstract*)(o->parent()->parent()->parent()->parent()->user_data()))->cb_validateBtn_i(o,v);
}
...
void QuestionUIAbstract::cb_nextBtn(fltk::Button* o, const char* v) {
  ((QuestionUIAbstract*)(o->parent()->parent()->parent()->parent()->user_data()))->cb_nextBtn_i(o,v);
}

QuestionUIAbstract::QuestionUIAbstract() {
  fltk::Window* w;
